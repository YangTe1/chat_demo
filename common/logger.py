...
normal_log_path = os.getenv('normal_log_path', f'{log_dir_path}/logs/running.log')
warn_log_path = os.getenv('warn_log_path', f'{log_dir_path}/logs/warn.log')
error_log_path = os.getenv('error_log_path', f'{log_dir_path}/logs/error.log')
